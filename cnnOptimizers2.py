...
for idx in range (0,len(optimizers)):
	name = 'optimizers3/cnn ' +str(optimizers[idx] +'.h5')
...
accuracies_df.to_csv("optimizers3/accuracies.csv")

val_accuracies_df = pd.DataFrame([array for array in val_accuracies] )
val_accuracies_df.to_csv("optimizers3/val_accuracies.csv")

test_accuracies_df = pd.DataFrame(test_accuracies )
test_accuracies_df.to_csv("optimizers3/test_accuracies.csv")

losses_df = pd.DataFrame([array for array in losses] )
losses_df.to_csv("optimizers3/losses.csv")

val_losses_df = pd.DataFrame([array for array in val_losses] ) 
val_losses_df.to_csv("optimizers3/val_losses.csv")
