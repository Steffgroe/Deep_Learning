...
for idx in range (0,len(activation)):
	name = 'activation/cnn ' +str(activation[idx] +'.h5')
...
accuracies_df.to_csv("activation2/accuracies.csv")

val_accuracies_df = pd.DataFrame([array for array in val_accuracies] )
val_accuracies_df.to_csv("activation2/val_accuracies.csv")

test_accuracies_df = pd.DataFrame(test_accuracies )
test_accuracies_df.to_csv("activation2/test_accuracies.csv")

losses_df = pd.DataFrame([array for array in losses] )
losses_df.to_csv("activation2/losses.csv")

val_losses_df = pd.DataFrame([array for array in val_losses] ) 
val_losses_df.to_csv("activation2/val_losses.csv")
